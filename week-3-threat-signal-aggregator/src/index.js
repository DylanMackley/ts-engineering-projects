...
import { checkDomainAge }  from "./signals/domainAge.js";
import { checkSSLAge }    from "./signals/sslAge.js";
...
const [urlscanSignal, googleSignal, velocitySignal, domainAgeSignal, sslAgeSignal] = await Promise.all([
  ...
  return fuseSignals(url, keywordSignal, urlscanSignal, googleSignal, velocitySignal, domainAgeSignal, sslAgeSignal);
}
